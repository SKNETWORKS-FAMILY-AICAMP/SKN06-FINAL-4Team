...
def generate_instagram_post(user_question, movie_titles):
    ...
    prompt_template = ChatPromptTemplate.from_template("""
        ...
        1. 검색한 영화 혹은 시리즈에 대한 리뷰 한 줄을 작성해줘. 
            - 검색하는 영화나 시리즈는 최소 5개에서 20개까지 입력받을 수 있어. 즉, 입력받은 영화 모두에 대해서 리뷰 한줄을 작성해주어야 해. 
        ...
        2. 게시물들을 기반으로 인스타그램 감성과 타겟층에 이목을 끄는 전체 게시물 제목을 작성해줘.
            ...
            - 전체 게시글 제목은 반드시 3줄로 작성해. 반드시.
            - 줄과 줄 사이는 '\n'으로 구분해줘. 
            - 첫번째 줄은 부제목이야.
            - 두번째와 세번째 줄은 제목을 작성하되, 한 문장을 가독성 좋게 두 줄로 나눠줘.
            - 3줄 모두 각각 10글자를 넘어가서는 안돼.
            - 부제목은 친근한 말투, 제목은 감각적으로 작성해줘.

        3. 전체 게시물 제목에 걸맞는 게시글을 300자 이내로 작성해줘.
            - 이모티콘을 적극 활용해서 글을 작성해줘. 

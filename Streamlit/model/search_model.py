...
# 엑셀 DB 로드
FAISS_KEY_WORD_INDEX_FILE = "recommend_data/key_word_faiss_index.idx"
KEY_WORD_INDICES_FILE = "recommend_data/key_word_indices.npy"
...
def search_movies_with_faiss(expanded_keywords, mumupoint, top_k=300):
    """
    ...
    final_results_df = recommended_movies_df[recommended_movies_df['별점'] >= float(mumupoint)]

    return final_results_df  # ✅ 결과 반환
